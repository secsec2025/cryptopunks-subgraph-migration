module.exports = class Data1698819047426 {
    name = 'Data1698819047426'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "event" ("id" character varying NOT NULL, "contract_id" character varying, "nft_id" character varying, "to_id" character varying, "amount" numeric, "from_id" character varying, "type" character varying(11) NOT NULL, "log_number" numeric NOT NULL, "block_number" numeric NOT NULL, "block_hash" bytea NOT NULL, "tx_hash" bytea NOT NULL, "timestamp" numeric NOT NULL, CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`)
