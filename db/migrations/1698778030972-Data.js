module.exports = class Data1698778030972 {
    name = 'Data1698778030972'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "event" ("id" character varying NOT NULL, "contract_id" character varying, "nft_id" character varying, "to_id" character varying, "amount" numeric, "from_id" character varying, "type" character varying(11) NOT NULL, "offer_id" character varying, "log_number" numeric NOT NULL, "block_number" numeric NOT NULL, "block_hash" bytea NOT NULL, "tx_hash" bytea NOT NULL, "timestamp" numeric NOT NULL, CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "offer" ("id" character varying NOT NULL, "from_id" character varying, "open" boolean NOT NULL, "amount" numeric NOT NULL, "nft_id" character varying, "created_id" character varying, "removed_id" character varying, "offer_type" character varying(3) NOT NULL, CONSTRAINT "PK_57c6ae1abe49201919ef68de900" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "punk" ("id" character varying NOT NULL, "transfered_to_id" character varying, "assigned_to_id" character varying, "token_id" numeric NOT NULL, "owner_id" character varying, "wrapped" boolean NOT NULL, "current_ask_id" character varying, "current_bid_id" character varying, "current_ask_created_id" character varying, "current_bid_created_id" character varying, "number_of_transfers" numeric NOT NULL, "number_of_sales" numeric NOT NULL, "current_ask_removed_id" character varying, "total_amount_spent_on_punk" numeric NOT NULL, "average_sale_price" numeric NOT NULL, "purchased_by_id" character varying, "contract_id" character varying, "current_bid_removed_id" character varying, CONSTRAINT "PK_d63ed31964aae4be18cdacff38b" PRIMARY KEY ("id"))`)
